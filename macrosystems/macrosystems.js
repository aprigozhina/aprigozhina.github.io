let myMap = L.map('macrosystems').setView([38.00, -95.00], 4)
...
let travelTime = L.tileLayer('https://tiles.traveltimeplatform.com/styles/positron/{z}/{x}/{y}.png?key=YOUR_APPLICATION_ID', {
