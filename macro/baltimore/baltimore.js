...
let myMap = L.map('baltimore_sites').setView([39.30, -76.61], 10)
...
jQuery.getJSON(allSites, function (data){
	points = L.geoJson(data, {
		...
		filter: function (feature, layer) {
			if (feature.properties.city === "Baltimore") { return true } // Filters objects from this city from a whole set
		},
